...
@property (nonatomic, weak) ALODCAdapter *parentAdapter;
@property (nonatomic, strong) id<MARewardedAdapterDelegate> delegate;
@property (nonatomic, copy) NSString *placementId;
@property (nonatomic, assign, getter=hasGrantedReward) BOOL grantedReward;
- (instancetype)initWithParentAdapter:(ALODCAdapter *)parentAdapter placementId:(NSString *)placementId andNotify:(id<MARewardedAdapterDelegate>)delegate;
@end
...
@property (nonatomic, copy) NSString *placementId;
- (instancetype)initWithParentAdapter:(ALODCAdapter *)parentAdapter placementId:(NSString *)placementId andNotify:(id<MAInterstitialAdapterDelegate>)delegate;
@end
...
@property (nonatomic, copy) NSString *placementId;
- (instancetype)initWithParentAdapter:(ALODCAdapter *)parentAdapter placementId:(NSString *)placementId andNotify:(id<MAAdViewAdapterDelegate>)delegate;
@end
...
@property (nonatomic, copy) NSString *placementId;
- (instancetype)initWithParentAdapter:(ALODCAdapter *)parentAdapter placementId:(NSString *)placementId andNotify:(id<MANativeAdAdapterDelegate>)delegate;
@end

@interface MAODCAdManagerNativeAd : MANativeAd
@property (nonatomic, weak) ALODCAdapter *parentAdapter;
- (instancetype)initWithParentAdapter:(ALODCAdapter *)parentAdapter builderBlock:(NS_NOESCAPE MANativeAdBuilderBlock)builderBlock;
@end
...
@implementation ALSerafinoAdapter
...
- (void)didDisplayAd:(ODCAd *)ad withError:(ODCError *)error { 
    ...
    MAAdapterError *adapterError = [ALODCAdapter toMaxError:error];
    if (error) {
